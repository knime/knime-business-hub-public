...
```
kubectl apply -f https://raw.githubusercontent.com/knime/knime-business-hub-public/updating-network-and-rbac-guide-hub-18/security/clusterroles/clusterroles.yaml
```
